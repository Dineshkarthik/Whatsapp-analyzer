...
def index():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            response['message_count'] = messages[
                'sender'].value_counts().head(10).to_dict()
            ...
            response['active_day_of_week'] = week_day(
                messages['weekday'].value_counts().idxmax())
            response['active_hour_of_day'] = hour(
